...
class VoucherContentGenerator {
  static Future<(String, int)> generateVoucherContent(
    ...
    try {
      ...
      final barcodeImageCommand =
          await VoucherContentHelper.generateBarcodeImage(
            voucherNumber,
            width: int.parse(ContentGeneratorParams.textBlockWidth),
          );

      label.write(
        '^FO${ContentGeneratorParams.startPosition},$currentVerticalPosition,$barcodeImageCommand',
      );
