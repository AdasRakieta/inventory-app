    ...
    override fun initialize(context: Context?):Boolean{
      ...
      if(context!=null){
        try{
          ...
          context.registerReceiver(barcodeDataReceiver, filter, android.content.Context.RECEIVER_EXPORTED)
          val filter2=IntentFilter()
          filter2.addCategory("android.intent.category.DEFAULT")
          filter2.addAction(RESULT_ACTION)
          context.registerReceiver(barcodeDataReceiver, filter2, android.content.Context.RECEIVER_EXPORTED)
          ...
          context.registerReceiver(barcodeDataReceiver, filterNotification, android.content.Context.RECEIVER_EXPORTED)
          return true
        } catch (e: Exception) {
