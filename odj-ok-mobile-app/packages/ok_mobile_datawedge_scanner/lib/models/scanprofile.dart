...
import 'package:ok_mobile_datawedge_scanner/models/barcode_plugin.dart';
...
class ScanProfile {
  ...
  Future<bool> sendCommands(ScanwedgeChannel scanWedge) async {
    ...
    final result = await scanWedge.sendCommandBundle(
      command: ScanCommands.datawedgeSendSetConfig,
      parameter: json,
      sendResult: true,
    );
