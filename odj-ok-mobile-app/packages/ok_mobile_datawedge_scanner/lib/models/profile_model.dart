import 'package:ok_mobile_datawedge_scanner/models/aimtype.dart';
import 'package:ok_mobile_datawedge_scanner/models/barcodetype_enum.dart';
...
class ProfileModel {
  ...
  Map<String, dynamic> get toMap => {
    ...
    if (enabledBarcodes != null)
      'barcodes': enabledBarcodes!.map((e) => e.toMap).toList(),
    if (!keepDefaults) 'keepDefaults': keepDefaults,
    'hwConfig': customMap,
  };
  factory ProfileModel.fromMap(Map<String, dynamic> map) => ProfileModel(
    profileName: map['name'],
    enabledBarcodes: map['barcodes'] != null
        ? List<BarcodeConfig>.from(
            map['barcodes'].map((x) => BarcodeConfig.fromMap(x)),
          )
        : null,
