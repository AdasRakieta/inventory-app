...
class BarcodePlugin {
  ...
  BarcodePlugin({
    ...
    this.timeoutBetweenScans = 0,
    this.disabledBarcodes,
  ...
  Map get _mapOfDisabledBarcodes => disabledBarcodes == null
      ? {}
      : {
          for (final entry in disabledBarcodes!)
            'decoder_${fetchDecoderName(entry)}': 'false',
        };
  Map get _mapOfEnabledBarcodes => enabledBarcodes == null
      ? {}
      : {
          for (final entry in enabledBarcodes!)
